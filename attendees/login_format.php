...
function return_failed() {
    header('Location: /attendees/login.php?ssl=true&failed=true');
}
...
$safeQuery = "SELECT * FROM `users` WHERE `emailaddress`='$cleanData[emailaddress]' AND `password`='$cleanData[password]';";
